...
export default function TermsPage() {
  return (
    <main className="portal-shell">
      <header className="portal-header"><Link href="/" className="brand"><span className="brand-mark">A</span><span><strong>ATLAS</strong><small>CONDITIONS D’UTILISATION</small></span></Link><span className="environment-badge">PROJET — NON CONTRACTUEL</span></header>
      <section className="portal-hero compact"><p className="kicker">CADRE D’USAGE</p><h1>Une aide à la clarification, jamais une promesse médicale.</h1><p className="lead">Ce document fixe les limites fonctionnelles de la préproduction. Il devra être validé juridiquement avant toute vente ou ouverture au public.</p></section>
      ...
      <section className="portal-panel"><h2>Paiements</h2><p>Les paiements restent limités au sandbox tant que l’entité juridique, les prix, la fiscalité, les politiques de remboursement et les versions contractuelles définitives ne sont pas configurés.</p></section>
    </main>
  );
}
