...
export default function TermsPage() {
  ...
  return (
    <main className="portal-shell">
      ...
      <section className="portal-panel"><h2>Contacts</h2><p>Support : {legal.supportEmail || "à compléter"} · Confidentialité : {legal.privacyEmail || "à compléter"} · Sécurité : {legal.securityEmail || "à compléter"}</p></section>
    </main>
  );
}
