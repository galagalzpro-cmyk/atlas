...
const CAPABILITIES = [
  ["01", "Comprendre", "Maintenir le fil, distinguer faits et hypothèses, ajuster la profondeur et reconnaître l’incertitude."],
  ["02", "Raisonner", "Organiser ce qui est confus, comparer plusieurs lectures possibles et mobiliser davantage de calcul lorsque le contexte le justifie."],
  ["03", "Accompagner", "Écouter, ralentir, clarifier, proposer ou laisser de l’espace selon ce que la situation semble demander."],
  ["04", "Garder le fil", "Maintenir une continuité limitée à la session, sans transformer l’échange émotionnel en donnée marketing."],
  ["05", "Protéger", "Changer de mode lorsque la sécurité devient prioritaire et privilégier des mécanismes vérifiables."],
