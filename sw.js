const CACHE='atlas-neural-v1';
const CORE=['./','index.html','styles.css','app.js','manifest.webmanifest','assets/hero-2k.webp','assets/neural-bust-square.webp','assets/atlas-logo-hero-transparent.png','assets/icon-192.png'];
